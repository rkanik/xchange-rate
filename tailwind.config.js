...
module.exports = {
	...
	theme: {
		...
		fontFamily: {
			...
			bl: ["Bestlife", "sans-serif"],
		},
		fontSize: {
			"2px": ["4px", { lineHeight: "6px" }],
			"6px": ["6px", { lineHeight: "6px" }],
			xxs: ["0.5rem", { lineHeight: ".5rem" }],
			...
			"11px": ["11px", { lineHeight: "1rem" }],
			"12px": ["12px", { lineHeight: "1rem" }],
			"13px": ["13px", { lineHeight: "1rem" }],
			"18px": ["18px", { lineHeight: "1rem" }],
			"22px": ["18px", { lineHeight: "1rem" }],
			"45px": ["45px", { lineHeight: "1rem" }],
			"9px": ["9px", { lineHeight: "1rem" }],
			"20px": ["20px", { lineHeight: "2rem" }],
		},
		fontWeight: {
			thin: "100",
			extralight: "200",
